...
tidycensusvariables2018 <- load_variables(year = 2018, dataset = "acs5/profile")
...
This code is telling R to take the `label` variable in `tidycensusvariables2020` and separate it into columns based on the seperator "!!". This is going to make it a lot easier to search using "filter" in `View()`. Please see the video for more details about searching for variables. 
...
```{r message=FALSE, warning=FALSE, results=FALSE}
	id_acs_tract <- get_acs(
  geography = "tract",
  state = "Idaho",
  county = "Ada County",
  variables = c(female_pct = "DP05_0003P",
                median_hh_income = "DP03_0062",
                median_family_income = "DP03_0086",
                pct_below_poverty = "DP03_0119P"),
  output = "wide",
  geometry = TRUE,
  year = 2018
)
