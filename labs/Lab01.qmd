...
In the left side bar you'll see a header, "Space", under which you'll see "Your Workspace" and "SPS 502-Fall25". Click SPS 502-Fall25 to view the list of projects associated with our class.
...
In the files pane you'll see the [project file](https://support.posit.co/hc/en-us/articles/200526207-Using-RStudio-Projects), an RMarkdown file named Lab01_Lastname_Firstname.Rmd. Click the checkbox next to the file then click "rename", as shown below.
