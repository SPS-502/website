...
{{< video https://www.youtube.com/watch?v=AdSZJzb-aX8 width="100%" height="100%">}}

# Principles

## 

![](images/clipboard-1026078641.png)

<small>Tufte 2001 (p. 51)</small>

## Time-Space

![](images/clipboard-639045667.png)

<small>The air pollution display is a *small multiple*. The same graphical design structure is repeated for each of the twelve slices or multi-ples. Small multiples are economical: once viewers understand the design of one slice, they have immediate access to the data in all the other slices. Thus, as the eye moves from one slice to the next, the constancy of the design allows the viewer to focus on changes in the data rather than on changes in graphical design.\<`/small>`{=html}
...
::: {.column width="50%"}
```{r ref.label = "idaho-color", echo = FALSE, warning = FALSE, out.width = "100%", fig.width = 5}
```
:::
...
::: {.column width="50%"}
```{r ref.label = "idaho-shape", echo = FALSE, warning = FALSE, out.width = "100%", fig.width = 5}
```
:::
...
::: {.column width="50%"}
```{r ref.label = "idaho-alpha", echo = FALSE, warning = FALSE, out.width = "100%", fig.width = 5}
```
:::
...
::: {.column width="50%"}
```{r ref.label = "idaho-size", echo = FALSE, warning = FALSE, out.width = "100%", fig.width = 5}
```
:::
...
::: {.column width="60%"}
```{r idaho-ed, fig.show = "hide", warning = FALSE, echo = TRUE}
...
::: {.column width="40%"}
```{r ref.label = "idaho-ed", echo = FALSE, warning = FALSE, out.width = "100%", fig.width = 4}
```
:::
