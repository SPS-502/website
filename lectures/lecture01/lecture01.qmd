...
1. Social Science Research Overview 
2. R Survival Tips 
3. Finding/Reading Published Research
...
-   **Empirical research** seeks to answer questions about how the world *is*
    -   Factual, based on observation (data), (more) objective(ish)
...
::: incremental
-   **Descriptive research** seeks to characterize the nature of a problem or phenomena.
...
-   Make mistakes
-   Take notes
-   Google your problems (or ask ChatGPT/Gemini/Claude with caution)
